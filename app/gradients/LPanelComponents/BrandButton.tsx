            ...
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <button
                            className={`w-full items-center justify-between flex px-4 py-2 mt-1 text-left rounded-xl text-xs transition-all duration-300 ${isSelected
                                ? `${textColor} font-serif`
                                : 'bg-amber-100/25 text-zinc-700 hover:bg-amber-100 dark:bg-zinc-800/25 dark:text-zinc-300 dark:hover:bg-zinc-700 font-serif'
                                }`}
